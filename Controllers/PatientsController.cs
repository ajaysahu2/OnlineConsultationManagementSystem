...
namespace OnlineConsultationManagementSystem.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,MobileNumber,Address")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,MobileNumber,Address")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
