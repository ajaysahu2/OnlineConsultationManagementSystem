        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInfo = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SessionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Session_Date_Time = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "DoctorId", "ContactInfo", "Name", "Specialization" },
                values: new object[] { 1, 9696655411L, "Ram", "Physician" });

            migrationBuilder.InsertData(
                table: "Patient",
                columns: new[] { "PatientId", "Address", "ContactInfo", "DateOfBirth", "Gender", "Name" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Sessions",
                columns: new[] { "SessionId", "Session_Date_Time", "VideoLink" },
